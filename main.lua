...
AirHub = {
	["Accent"] = Color3.fromRGB(96, 140, 201),
	["Window Background"] = Color3.fromRGB(40, 40, 40),
	["Window Border"] = Color3.fromRGB(61, 61, 61),
	["Tab Background"] = Color3.fromRGB(61, 61, 61),
	["Tab Border"] = Color3.fromRGB(66, 66, 66),
	["Tab Toggle Background"] = Color3.fromRGB(32, 32, 32),
	["Section Background"] = Color3.fromRGB(32, 32, 32),
	["Section Border"] = Color3.fromRGB(36, 36, 36),
	["Text"] = Color3.fromRGB(214, 214, 214),
	["Disabled Text"] = Color3.fromRGB(110, 110, 110),
	["Object Background"] = Color3.fromRGB(37, 37, 37),
	["Object Border"] = Color3.fromRGB(44, 44, 44),
	["Dropdown Option Background"] = Color3.fromRGB(31, 31, 31)
}
}

local themeobjects = {}

local library = utility.table({theme = table.clone(themes.AirHub), folder = "iris", extension = "cfg", flags = {}, open = true, keybind = Enum.KeyCode.RightShift, mousestate = services.InputService.MouseIconEnabled, cursor = nil, holder = nil, connections = {}}, true)
...
function library:Load(options)
	...
	local cursor = utility.create("Triangle", {
		Thickness = 6,
		Color = Color3.fromRGB(96, 140, 201),
		ZIndex = 1000
	})
